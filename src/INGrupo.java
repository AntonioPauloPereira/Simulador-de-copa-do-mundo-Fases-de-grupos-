...
public class INGrupo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnProximo.setFont(new java.awt.Font("sansserif", 0, 24)); // NOI18N
    ...
    if (selecoesDoGrupo.isEmpty()) {
        javax.swing.JOptionPane.showMessageDialog(this, "Adicione pelo menos uma seleção ao grupo antes de salvar.");
        return;
    }

    // 2. Tira a "foto" da lista atual para não apagar por referência depois
    java.util.List<String> listaSalvar = new java.util.ArrayList<>(selecoesDoGrupo);
    ...
    // 5. RESETA OS CAMPOS PARA O PRÓXIMO GRUPO
    limparCamposGrupo();
    }//GEN-LAST:event_btnSalvarActionPerformed
    
    private void limparCamposGrupo() {
    jtfNomeGrupo.setText("");     // Apaga o texto (ex: "Grupo A") para virar campo em branco
    modeloLista.clear();          // Limpa o JList visual da tela
    selecoesDoGrupo.clear();      // Esvazia a lista lógica na memória para o Grupo B começar do zero
}
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        // TODO add your handling code here:
        // Abre a tela de Confrontos/Classificação
    INConfronto telaConfronto = new INConfronto();
    telaConfronto.setVisible(true);
    telaConfronto.setLocationRelativeTo(null);
    
    // Fecha a tela de grupos atual
    this.dispose();
